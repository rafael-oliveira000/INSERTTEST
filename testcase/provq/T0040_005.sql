...
Insert into PROV_Q (SRV_TRX_S_NO,SYS_CREATION_DATE,SYS_UPDATE_DATE,OPERATOR_ID,APPLICATION_ID,DL_SERVICE_CODE,DL_UPDATE_STAMP,PRIM_RESOURCE_VAL,PRIM_RES_PARAM_CD,MARKET_CODE,PRIORITY,IGN_SUB_DEPEND_IND) values (recorder.SEQUENCE,to_timestamp('06/09/23 09:40:27','DD/MM/RR HH24:MI:SSXFF'),null,null,'CMGOLC','CS030',null,'37932014213','MSISDN','MTA',null,'N');
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','CUSTOMER=129496845;SUBSCRIBER_STATUS=A;PRICE_PLAN=380465367;ACCOUNT_ID=136256927; ');
...
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','FTRCD=VPNST;FTR_STATUS=A;CC=268703452;CCNM=CC_CLARO LIFE_GOL II;DPTO1=268703453;DPTONM1=DPTO_CLARO LIFE_GOL II; ');
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','FTRCD=MSISDN;FTR_STATUS=A;MSISDN=37932014213; ');
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','FTRCD=SIMCARD;FTR_STATUS=A;ICCID=89550534120031238073;IMSI=724053790166345;CHV5=3434311111111117;KI=oHhhoMMMMMMMMMMMgoMMMMMMMMMMMMMMCv;PIN_1=3636;PIN_2=6363;PUK_1=42424242;PUK_2=24242424;TRANSK=8; ');
...
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','FTRCD=RSNCD;FTR_STATUS=A;REASON_CODE=CREQ; ');
...
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','FTRCD=SUBNO;FTR_STATUS=A;SUBSCRIBER_NO=925412764; ');
...
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','FTRCD=CNPJ;FTR_STATUS=A;CNPJ_VAL=05323213000178; ');
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','FTRCD=CPF;FTR_STATUS=A;CPF_VAL=           053; ');
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','FTRCD=CUSTN;FTR_STATUS=A;CUSTNM=TAY TESTE GOL; ');
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','FTRCD=BLCYC;FTR_STATUS=A;BILLCYC=4;BLDAY=15; ');
Insert into PROV_Q_FTR (SRV_TRX_S_NO,NEW_OR_PREV,FEATURES) values (recorder.SEQUENCE,'N','FTRCD=SUBNM;FTR_STATUS=A;SUBSCRIBER_NAME=TAYOBA CONDICIONAMENTO FISICO LTDA; ');
Commit;
