...
INSERT INTO PROV_Q (SRV_TRX_S_NO , SYS_CREATION_DATE, SYS_UPDATE_DATE , OPERATOR_ID, APPLICATION_ID, DL_SERVICE_CODE, DL_UPDATE_STAMP, PRIM_RESOURCE_VAL , PRIM_RES_PARAM_CD, MARKET_CODE , PRIORITY, IGN_SUB_DEPEND_IND) VALUES  (recorder.SEQUENCE, SYSDATE, NULL, 60001, NULL,'CS030', NULL,'72994601951','MSISDN' ,'MTA', NULL,'N'); 
INSERT INTO PROV_Q_FTR (SRV_TRX_S_NO, NEW_OR_PREV, FEATURES) VALUES (recorder.SEQUENCE,'N','FTRCD=TCNAM;FTR_STATUS=A;TC_NAME=T0040_055.sql;');
INSERT INTO PROV_Q_FTR (SRV_TRX_S_NO, NEW_OR_PREV, FEATURES) VALUES (recorder.SEQUENCE,'N','FTRCD=TCDSC;FTR_STATUS=A;DESC=ESIM MNC05 MSIN36 CN72;');
...
INSERT INTO PROV_Q_FTR (SRV_TRX_S_NO, NEW_OR_PREV, FEATURES) VALUES (recorder.SEQUENCE,'N','FTRCD=MSISDN;FTR_STATUS=A;MSISDN=72994601951;');
